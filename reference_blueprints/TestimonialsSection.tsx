    ...
    <section className="section max-w-7xl mx-auto container-px">
      <div className="text-center mb-14">
        <h2 className="font-display text-5xl md:text-6xl tracking-wider text-white mb-4">
          FROM THE<br />
          <span className="text-alien-green">CREW</span>
        </h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        {reviews.map((review) => (
          <div
            key={review.name}
            className="relative p-6 bg-space-800 border border-muted/10 rounded-2xl overflow-hidden"
          >
            {/* Accent */}
            <div
            ...
            <p className="text-sm text-muted/90 leading-relaxed mb-4 italic">
              "{review.text}"
            </p>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                ...
                <span
                  ...
                  style={{ color: review.color, background: `${review.color}15`, border: `1px solid ${review.color}30` }}
                >
                  {review.product}
                </span>
              </div>
