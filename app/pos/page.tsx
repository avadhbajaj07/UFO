...
const SEEDED_POS_PRODUCTS = [
  { id: 'prod-col', title: 'Astro Collagen Peptide (300g)', sku: 'COL-300G', barcode: '764000111222', category: 'special-edition', price: 34, base_price: 42, stock: 500, desc: 'Premium hydrolyzed grass-fed collagen peptides optimized for rapid absorption, joint strength, and skin elasticity.', image: 'https://res.cloudinary.com/dm4jfxbcs/image/upload/v1782667545/UFO1_ztlvyz.png', color: '#9B30FF', expiry: '2028-12-31' },
  { id: 'prod-blast-energy', title: 'Blast Pre-Workout (Energy Drink)', sku: 'BLAST-ENERGY-300G', barcode: '764000333444', category: 'pre-workout', price: 24, base_price: 29, stock: 400, desc: 'Explosive energy and laser focus formula for extreme pre-workout performance in refreshing citrus energy drink flavor.', image: 'https://res.cloudinary.com/dm4jfxbcs/image/upload/v1782667544/UFO3_bfwhlr.png', color: '#FF2244', expiry: '2027-08-15' },
  { id: 'prod-creatine', title: 'Astro Creatine Pure (500g)', sku: 'ASTRO-500G', barcode: '764000555666', category: 'creatine', price: 19, base_price: 24, stock: 600, desc: 'Premium 100% micronized creatine monohydrate for explosive power, muscle hypertrophy, and cellular recovery.', image: 'https://res.cloudinary.com/dm4jfxbcs/image/upload/v1782667544/UFO4_nuzyls.png', color: '#00FF88', expiry: '2028-10-10' },
  { id: 'prod-amino-mango', title: 'Amino Fuel EAA (Mango)', sku: 'AMNO-MANGO-300G', barcode: '764000777888', category: 'amino-acids', price: 17.90, base_price: 21.90, stock: 450, desc: 'Complete Essential Amino Acids (EAA) matrix with added hydration electrolytes in delicious mango flavor.', image: 'https://res.cloudinary.com/dm4jfxbcs/image/upload/v1782667544/UFO5_l42elt.png', color: '#FF8C00', expiry: '2027-06-20' },
  { id: 'prod-blast-blue', title: 'Blast Pre-Workout (Blue Raspberry)', sku: 'BLAST-BLUE-300G', barcode: '764000999000', category: 'pre-workout', price: 24, base_price: 29, stock: 350, desc: 'Extreme pre-workout energy and focus formula featuring an electric blue raspberry flavor profile.', image: 'https://res.cloudinary.com/dm4jfxbcs/image/upload/v1782667544/UFO2_hnupdu.png', color: '#00CFFF', expiry: '2027-11-25' },
  { id: 'prod-amino-blue', title: 'Amino Fuel EAA (Blue Raspberry)', sku: 'AMNO-BLUE-300G', barcode: '764000888999', category: 'amino-acids', price: 17.90, base_price: 21.90, stock: 350, desc: 'Full essential amino acids matrix paired with advanced electrolytes in a cold blue raspberry flavor.', image: 'https://res.cloudinary.com/dm4jfxbcs/image/upload/v1782667544/UFO6_uhxvep.png', color: '#00CFFF', expiry: '2028-01-10' }
]
